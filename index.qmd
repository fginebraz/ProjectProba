...
El resultado teórico es que el estadístico de orden para el máximo de una muestra de tamaño $n$ de uniformes (0,1) se distribuye $Beta(n, 1)$.

Lo que tenemos aquí es un desplazamiento. Sigue siendo una distribución Beta, pero con un parámetro de localización diferente. En concreto, la media de U=M-5 es ahora (n-1)/(n+1) - 5, que está desplazada hacia la izquierda 5 unidades en comparación con la media de M.
...
Usamos un loop para creae las gráficas y guardarlas en la lista.
...
Vemos la probabilidad de que menos de 15 o 15 personas tengan su clave única
...
Son sumas de variables aleatorias independientes e idénticamente distribuidas.
